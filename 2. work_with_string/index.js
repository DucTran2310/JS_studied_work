...
// 5.preventSpecialCharacter
// => only enter string and number
export function preventSpecialCharacters(characters) {
    return characters.replace(/[`~!@#$^&*()|+\-=?;:'",.<>\{\}\[\]\\\/]/gi, '')
}

// 6.Remove Vietnamemes
